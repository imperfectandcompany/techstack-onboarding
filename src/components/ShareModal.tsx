...
interface ContainerProps { 
  optionalParentfunction?:Function;
}
...
const ShareModal = (props:ContainerProps) => {
  ...
  const printSheetLight = () => {
    return (
      <div className="flex items-center justify-center ">
        <div className="w-full p-4 mx-4 rounded-xl md:w-1/2 lg:w-1/3">
          <div
            className="flex justify-between py-3 border-b border-gray-200 items center"
          >
            <div className="flex items-center justify-center">
              <p className="text-sm font-bold text-gray-800">Sharing</p>
            </div>

            <div
              className="flex items-center justify-center w-8 h-8 font-sans text-gray-500 "
            >
              <IonIcon size="small" onClick={() => handleClick()} icon={close}></IonIcon>
            </div>
          </div>
          ...
          <div className="my-4">
            ...
            <div className="flex items-center justify-between py-2 mt-4 border-2 border-gray-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
              ...
              <button className="px-5 py-2 mr-2 text-sm text-white bg-indigo-500 rounded hover:bg-indigo-600">
                Copy
              </button>
            </div>
          </div>
  ...
  const printSheetDark = () => {
    return (
      <div className="flex items-center bg-white dark:bg-zinc-900 justify-center ">
        <div className="w-full p-4 mx-4 rounded-xl md:w-1/2 lg:w-1/3">
          <div
            className=""
          >
            <IonItem color='secondary ' lines="full">
              ...
              <div className={isOpen === true ? "nav-container active" : "nav-container"}><nav>
                <div className="menu-icon-container mx-auto " onClick={() => setIsOpen(false)} >
          ...
          <div className="my-4">
            ...
            <IonList color="secondary">
              <div className="flex">
                <IonItem lines="none" color="primary" fill="solid" type="button">
                  <div
                    className="border hover:bg-[#1877f2] w-10 h-10 fill-[#1877f2] hover:fill-white border-blue-200 flex items-center justify-center shadow-xl hover:shadow-blue-500/50 cursor-pointer"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
            ...
            <div className="flex items-center justify-between py-2 mt-4 border-2 border-zinc-800">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
  ...
  return (
    <div>
      ...
      >
        <IonContent color="zinc" className="bg-zinc-900" class='bg-zinc-900'>
          {printSheetDark()}
        </IonContent>
      </IonModal>
      <a onClick={() => handleClick()} className="transition active:text-zinc-800">
      Share
      </a>
    </div>
  );
