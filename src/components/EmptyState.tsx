...
export const EmptyState: React.FC<EmptyStateProps> = (props) => {
  ...
  const printEmptyTimelineState = () => {
    return (
      <div className="p-4 bg-white dark:bg-zinc-900 ">
        <div className="relative p-6 text-center border border-zinc-200 dark:border-zinc-800 rounded-lg">
          <img src={props.imageSrc} className="animate__animated animate__fadeIn  w-64 sm:w-24 md:w-32 lg:w-36 my-8 flex mx-auto" alt="logo" />
