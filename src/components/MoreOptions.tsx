...
return(
  <div className="flex items-center justify-center ">
    ...
    const printSheetDark = () => {
      return(
        <div className="flex items-center bg-zinc-900 justify-center ">
            <div className="w-full p-4 mx-4 rounded-xl md:w-1/2 lg:w-1/3">
              <div
                className="flex justify-between py-3 border-b border-zinc-800 items center"
              >
                <div className="flex items-center justify-center">
                  <p className="text-sm font-bold text-zinc-400">Sharing</p>
                </div>
      
                <div
                  className="flex items-center justify-center w-8 h-8 font-sans text-zinc-500 "
                >
                    <IonIcon size="small" onClick={()=>setIsOpen(false)} icon={close}></IonIcon>
                </div>
              </div>
              ...
              <div className="my-4">
                <p className="text-sm text-zinc-400">Share this link via</p>
                ...
                <p className="text-sm text-zinc-400">Or copy link</p>
