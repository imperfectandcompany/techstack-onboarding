                ...
                <div className=" text-zinc-900">
                    <SwipeableViews className="text-zinc-300" index={tabIndex} onChangeIndex={handleChangeIndex}>
                                    ...
                                    <div className="flex justify-between border-t border-zinc-800 text-zinc-600 py-4 pl-6 pr-3 hover:bg-gray-500 transition duration-150">
                                        <div>
                                            <a className="text-white">
                                                <img src="https://miro.medium.com/max/512/1*nZ9VwHTLxAfNCuCjYAkajg.png" alt="" className="rounded-full h-6 shadow-md inline-block mr-2">
                                                </img>  Online
                                            </a></div>
                                    </div>
                                    <div className="flex justify-between border-t border-zinc-800 text-zinc-600 py-4 pl-6 pr-3 hover:bg-gray-500 transition duration-150">
                                        <div>
                                            <a className="text-white">
                                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Location_dot_grey.svg/1200px-Location_dot_grey.svg.png" alt="" className="rounded-full h-6 shadow-md inline-block mr-2">
                                                </img>  Offline
                                            </a></div>
                                    </div>
                                    <div className="flex justify-between border-t border-zinc-800 text-zinc-600 py-4 pl-6 pr-3 hover:bg-gray-500 transition duration-150">
                                        <div>
                                            <a className="text-white">
                                                <img src="https://www.seekpng.com/png/full/785-7852330_yellow-dot-png-transparent-circle-orange-png.png" alt="" className="rounded-full h-6 shadow-md inline-block mr-2">
                                                </img>  Away
                                            </a></div>
                                    </div>
                                    <div className="flex justify-between border-t border-zinc-800 text-zinc-600 py-4 pl-6 pr-3 hover:bg-gray-500 transition duration-150">
                                        <div>
                                            <a className="text-white">
                                                <img src="https://www.mysafetysign.com/img/lg/I/do-not-enter-iso-sign-is-1067.png" alt="" className="rounded-full h-6 shadow-md inline-block mr-2">
                                                </img>  Do Not Disturb
                                            </a></div>
                                    </div>
                        ...
                        <div className="flex text-zinc-300 bg-zinc-900">
                            <div className="w-full">
                                <div className="mt-5  flex flex-col  text-sm">
                                    <div className="flex justify-between border-t border-b border-zinc-800 text-zinc-600 py-4 pl-3 pr-3 hover:bg-gray-500 transition duration-150" onClick={() => setViewIndex(0)}>
                                        <div>
                                            <a className="text-white">
                                            <IonIcon size="small" color={viewIndex == 0 ? "light" :"bg-zinc-900"} className="mr-2" icon={checkmarkOutline}></IonIcon>
                                                  Normal
                                            </a></div>
                                            <div><span className="text-gray-100 text-xs">Traditional Postogon Layout</span></div>
                                    </div>
                                    <div className="flex justify-between border-t border-b  border-zinc-800 text-zinc-600 py-4 pl-3 pr-3 hover:bg-gray-500 transition duration-150" onClick={() => setViewIndex(1)}>
                                        <div>
                                            <a className="text-white">
                                            <IonIcon size="small" color={viewIndex == 1 ? "light" :"bg-zinc-900"} className="mr-2" icon={checkmarkOutline}></IonIcon>
                                                 Cozy
                                            </a></div>
                                            <div><span className="text-gray-100 text-xs">Posts are condensed for brevity</span></div>
                                    </div>
                                    <div className="flex justify-between border-t border-b border-zinc-800 text-zinc-600 py-4 pl-3 pr-3 hover:bg-gray-500 transition duration-150" onClick={() => setViewIndex(2)}>
                                        <div>
                                            <a className="text-white">
                                            <IonIcon size="small" color={viewIndex == 2 ? "light" :"bg-zinc-900"} className="mr-2" icon={checkmarkOutline}></IonIcon>
                                                 Expanded
                                            </a></div>
                                            <div><span className="text-gray-100 text-xs">Each post is shown in it's entirety</span></div>
                                    </div>
