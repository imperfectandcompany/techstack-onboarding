    ...
    <IonMenu side="start" contentId="main" menuId='mainmenu' type="push">
      ...
      <IonContent color="light">
        <div className=" dark:bg-zinc-900 bg-white rounded overflow-hidden">
          <div className="text-center p-6  border-b dark:border-zinc-800">
            <img
              className="h-24 w-24 rounded-full mx-auto"
              src="https://this-person-does-not-exist.com/img/avatar-1c30d3c8e9e4466db074e8bfec1fd79b.jpg"
              alt="Randy Robertson"
            />
          ...
          <IonAccordionGroup>
            ...
            <IonItem color="secondary" lines="full">
              ...
              <IonLabel className="ml-3 ">Archive</IonLabel>
            </IonItem>
          </IonAccordionGroup>
          ...
          <IonRouterLink onClick={async () => await menuController.toggle()} routerLink='/settings' routerDirection='forward' >
              <div className="px-4 py-2 hover:bg-gray-100 dark:hover:bg-stone-900 flex items-center">
