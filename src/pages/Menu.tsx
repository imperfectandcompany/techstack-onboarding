...
const Menu: React.FC = () => {
  ...
  <div className="flex items-center p-4 border-t-2 border-zinc-700">
    ...
    <IonButton color="white" onClick={async () => await menuController.toggle()} fill="clear" routerLink="/settings" routerDirection="forward"  className="ml-auto cursor-pointer">
